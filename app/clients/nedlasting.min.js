...
NK.styles = NK.styles || {};
NK.styles.omrissFylker = new OpenLayers.StyleMap(
	{
	  'default': new OpenLayers.Style(
	    {
	      strokeWidth: 3,
...
NK.addLayerType.geoJSONFileMC = (function (M, MP, P) {
...
(function () {
  ...
  options.layerGroup = 'nedlasting';




  options.styleName = 'omrissFylker';
...
;
  ...
  NK.addLayerType.geoJSONFileMC('fylker', 'Fylker', '/json/norge/fylker.json', options);
}());
...
;
  ...
  NK.addLayerType.geoJSONFileMC('fylker-utm35', 'Fylker UTM35', '/json/norge/fylker-utm35.json', options);
}());
...
;
  ...
  NK.addLayerType.geoJSONFileMC('fylker-utm33', 'Fylker UTM33', '/json/norge/fylker-utm33.json', options);
}());
...
;
  ...
  NK.addLayerType.geoJSONFileMC('fylker-utm32', 'Fylker UTM32', '/json/norge/fylker-utm32.json', options);
}());
...
;
  ...
  NK.addLayerType.geoJSONFileMC('kommuner', 'Kommuner', '/json/norge/kommuner.json', options);
}());
...
;
  ...
  NK.addLayerType.geoJSONFileMC('kommuner-utm35', 'Kommuner UTM35', '/json/norge/kommuner-utm35.json', options);
}());
...
;
  ...
  NK.addLayerType.geoJSONFileMC('kommuner-utm33', 'Kommuner UTM33', '/json/norge/kommuner-utm33.json', options);
}());
...
;
  ...
  NK.addLayerType.geoJSONFileMC('kommuner-utm32', 'Kommuner UTM32', '/json/norge/kommuner-utm32.json', options);
}());
...
;
  ...
  NK.addLayerType.geoJSONFileMC('dtm-dekning-utm32', 'DTM Dekning UTM32', '/json/dekning/dtm/utm32.geojson', options);
}());
...
;
  ...
  NK.addLayerType.geoJSONFileMC('dtm-dekning-utm33', 'DTM Dekning UTM33', '/json/dekning/dtm/utm33.geojson', options);
}());
...
;
  ...
  NK.addLayerType.geoJSONFileMC('dtm-dekning-utm33-100km', 'DTM Dekning UTM33 100km grid', '/json/dekning/dtm/utm33-100km.geojson', options);
}());
...
;
  ...
  NK.addLayerType.geoJSONFileMC('dtm-dekning-utm35', 'DTM Dekning UTM35', '/json/dekning/dtm/utm35.geojson', options);
}());
...
;
  ...
  NK.addLayerType.geoJSONFileMC('raster-32', 'Raster UTM32', '/json/dekning/raster/32.geojson', options);
}());
...
;
  ...
  NK.addLayerType.geoJSONFileMC('raster-33', 'Raster UTM33', '/json/dekning/raster/33.geojson', options);
}());
...
;
  ...
  NK.addLayerType.geoJSONFileMC('raster-35', 'Raster UTM35', '/json/dekning/raster/35.geojson', options);
}());
...
;
  ...
  NK.addLayerType.geoJSONFileMC('raster-n50', 'Raster N50', '/json/dekning/raster/n50.geojson', options);
}());
...
;
  ...
  NK.addLayerType.geoJSONFileMC('raster-n250', 'Raster N250', '/json/dekning/raster/n250_ny.geojson', options);
}());
...
;
  ...
  NK.addLayerType.geoJSONFileMC('raster-n500', 'Raster N500', '/json/dekning/raster/n500_ny.geojson', options);
}());
...
;
  ...
  NK.addLayerType.geoJSONFileMC('raster-n1000', 'Raster N1000', '/json/dekning/raster/n1000_ny.geojson', options);
}());
